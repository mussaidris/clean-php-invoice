                    ...
                    <div class="col-lg-10">
                        <div class="p-5">
                            ...
                            <hr/>
								...
								<div class="col-sm-12">
								<label >Company name<span class="text-danger">*</span></label><span class="float-right">اسم الشركة</span>
                                    <input class="form-control " type="text" id="cname" value="<?php echo htmlentities($comp['company_name']);?>" name="cname" maxlength="255" required >
									</div>
									<div class="col-sm-6">
								...
								<label >VAT Number  </label><span class="float-right">رقم ضريبة القيمة المضافة</span>
                                    ...
                                    <textarea class="form-control " rows="3" id="address"  name="address" maxlength="255" required><?php echo htmlentities($comp['address']);?></textarea>
									</div>
